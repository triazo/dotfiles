...
xfiles="${basicfiles} scripts/p-urxvtc scripts/dwm_run.sh scripts/automon.sh scripts/xinit .config/dunst/dunstrc usr/src/dwm .xinitrc .xbindkeysrc .xmodmap scripts/touchpad.sh scripts/header.py"
